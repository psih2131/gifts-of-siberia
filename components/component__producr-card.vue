    ...
    <div class="product-card" v-if="productData">
        <div class="product-card__wrapper">
            <div class="product-card__top">
                ...
                <NuxtLinkLocale class="product-card__img-wrapper" :to="`/products/product/${productData.slug}`">
                ...
                <p class="product-card__title">
                    <NuxtLinkLocale class="product-card__title-link" :to="`/products/product/${productData.slug}`">
            ...
            <div class="product-card__down">
                <button class="product-card__btn-request" @click="openFormPopup()">
                    {{ $t('products.requestOpt') }}
                ...
                <NuxtLinkLocale class="product-card__btn-more-info" :to="`/products/product/${productData.slug}`">
                    {{ $t('products.moreInfo') }}
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
