    ...
    <div class="search-component" :class="{'search-component--activ': resultList, 'search-component--full': isFocused == true}">
        ...
        <div class="search-component__result-wrapper" v-if="resultList">
                    ...
                    <NuxtLink :to="`/products/product/${item.slug}`" class="search-result-element__wrapper">
                        ...
                        <div class="search-result-element__data">
                            ...
                            <ul class="product-card__list">
                                <li class="product-card__table-row" v-for="element in item.acf.spisok_izobrazhenij_soderzhimogo" :key="element">
                                    <p class="product-card__table-row-name">{{ element.nazvanie_sostava }}</p>
                                    <p class="product-card__table-row-value">{{ element.kolichestvo }}</p>
                                </li>
                            </ul>
                        </div>
                    </NuxtLink>
            ...
            <div v-else class="search-component__error">
                По ключевому запросу товаров не найдено
            </div>
        </div>
